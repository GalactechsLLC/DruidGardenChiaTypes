...
public class WordList {
	...
	public static final ConcurrentHashMap<CharSequence, String> normalizedMap = new ConcurrentHashMap<CharSequence, String>() {
...

		{
			for (int i = 0; i < 2048; i++) {
	            ...
	            put(Normalizer.normalize(word, Normalizer.Form.NFC), normalized);
	        }
		}
	};
	
	public static String normalize(final CharSequence charSequence) {
    ...
    public static String getWord(final int index) {
        return WORDS[index];
    }
}
